...
import { winterMelonMooncakeProductData as pageData } from "@/data/winter-melon-mooncake-detail";
      ...
      <div className="ysj-container grid gap-6 py-6 md:min-h-[620px] md:gap-8 md:py-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:gap-12 lg:py-12">
        <div className="relative z-10 flex max-w-[40rem] flex-col gap-4 md:gap-5 lg:gap-6">
          ...
          <div>
            ...
            <p className="mt-4 max-w-[560px] text-sm leading-[1.9] text-[#D6C09A] md:text-[17px]">
              {hero.description}
            </p>
          </div>
...
export function WinterMelonMooncakeProblems() {
...
export function WinterMelonMooncakeCraft() {
...
export function WinterMelonMooncakeTaste() {
...
export function WinterMelonMooncakeInfoGift() {
...
export function WinterMelonMooncakeRecommendations() {
...
export function WinterMelonMooncakeCTA() {
