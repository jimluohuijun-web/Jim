...
import { fiveNutsMooncakeProductData as pageData } from "@/data/five-nuts-mooncake-detail";
...
const processIcons: IconComponent[] = [Sparkles, Flame, Sprout, Layers3];
...
export function FiveNutsMooncakeHero() {
  const { hero } = pageData;

  return (
    <section className="relative isolate overflow-hidden border-b border-[rgba(217,180,106,0.18)] bg-[#070604]">
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_72%_38%,rgb(240_201_120_/_18%),transparent_30rem),radial-gradient(circle_at_32%_22%,rgb(240_201_120_/_9%),transparent_22rem),linear-gradient(135deg,#050302_0%,#160C08_46%,#090504_100%)]" />
      ...
      <div className="ysj-container grid gap-6 py-6 md:min-h-[640px] md:gap-8 md:py-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:gap-12 lg:py-12">
        ...
        <div className="relative hidden min-h-[270px] lg:block lg:min-h-[620px]">
          ...
          <div className="absolute inset-0 rounded-[2rem] bg-[radial-gradient(circle_at_52%_46%,rgb(240_201_120_/_13%),transparent_28rem),radial-gradient(circle_at_68%_54%,rgb(240_201_120_/_12%),transparent_22rem)]" />
...
export function FiveNutsMooncakeProblems() {
...
export function FiveNutsMooncakeHighlights() {
...
export function FiveNutsMooncakeCraft() {
    ...
    <section className="border-y border-[rgba(217,180,106,0.16)] bg-[#090504] py-14 md:py-20">
      <div className="ysj-container">
        <div className="relative overflow-hidden rounded-[1.25rem] border border-[rgba(217,180,106,0.3)] bg-[linear-gradient(135deg,rgb(18_12_7_/_92%),rgb(7_6_4_/_98%))] p-4 shadow-[0_28px_90px_rgb(0_0_0_/_36%)] md:rounded-[1.6rem] md:p-7">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgb(240_201_120_/_10%),transparent_22rem),radial-gradient(circle_at_86%_76%,rgb(216_154_66_/_8%),transparent_20rem)]" />
          ...
          <div className="relative">
                ...
                return (
                  <DetailCard key={item.title} className="group overflow-hidden">
                    ...
                    <div className="p-5">
                      ...
                      <p className="mt-3 text-sm leading-7 text-[#CDB98D]">{item.text}</p>
                    </div>
                  </DetailCard>
                );
              })}
            ...
            <div className="mt-7 flex flex-wrap justify-center gap-2">
              {craft.badges.map((badge) => (
                <span key={badge} className="rounded-full border border-[rgba(217,180,106,0.22)] bg-[#050302]/44 px-4 py-2 text-xs tracking-[0.16em] text-[#F0C978]/88 md:text-sm">
                  {badge}
                </span>
              ))}
            </div>
...
export function FiveNutsMooncakeTaste() {
...
export function FiveNutsMooncakeProcess() {
...
export function FiveNutsMooncakeInfoGift() {
...
export function FiveNutsMooncakeRecommendations() {
...
export function FiveNutsMooncakeCTA() {
  ...
  return (
    <section className="relative isolate overflow-hidden border-y border-[rgba(217,180,106,0.18)] bg-[#070604] py-14 md:py-22">
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_50%_0%,rgb(240_201_120_/_13%),transparent_30rem),radial-gradient(circle_at_72%_78%,rgb(240_201_120_/_10%),transparent_24rem),linear-gradient(180deg,#0F0B07_0%,#090504_100%)]" />
