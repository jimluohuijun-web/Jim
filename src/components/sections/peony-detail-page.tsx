...
import { peonyProductData as pageData } from "@/data/peony-detail";
...
export function PeonyHero() {
  const { hero } = pageData;

  return (
    <section className="relative isolate overflow-hidden border-b border-[rgba(217,180,106,0.18)] bg-[#070604]">
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_72%_38%,rgb(216_167_201_/_20%),transparent_30rem),radial-gradient(circle_at_32%_22%,rgb(240_201_120_/_9%),transparent_22rem),linear-gradient(135deg,#050302_0%,#160C08_46%,#090504_100%)]" />
      ...
      <div className="ysj-container grid gap-6 py-6 md:min-h-[640px] md:gap-8 md:py-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:gap-12 lg:py-12">
        <div className="relative z-10 flex max-w-[42rem] flex-col gap-4 md:gap-5 lg:gap-6">
          ...
          <div>
            <p className="mb-4 inline-flex w-fit rounded-full border border-[#D9B46A]/30 bg-[#120907]/70 px-4 py-2 text-xs font-medium tracking-[0.18em] text-[#F0C978] shadow-[0_10px_34px_rgb(0_0_0_/_28%)] md:text-sm">
              <Flower2 className="mr-2 size-4 text-[#D8A7C9]" />
              {hero.title}
            </p>
            <h1 className="max-w-[8em] font-serif text-[clamp(2.35rem,10.2vw,3.25rem)] font-semibold leading-[1.04] tracking-[0.01em] text-[#F2C36B] [overflow-wrap:anywhere] drop-shadow-[0_10px_34px_rgb(0_0_0_/_55%)] md:text-[clamp(4.2rem,5.4vw,5.8rem)] md:leading-[0.98] md:tracking-[0.02em]">
              {hero.headline}
            </h1>
          ...
          <div className="grid grid-cols-2 gap-2 pt-1 sm:grid-cols-4 md:gap-3">
            {hero.tags.map((tag, index) => {
              ...
              return (
                ...
                >
                  <Icon className="mb-2 size-4 text-[#D8A7C9] md:size-5" strokeWidth={1.45} />
        ...
        <div className="relative hidden min-h-[270px] lg:block lg:min-h-[620px]">
          <div className="absolute inset-x-4 bottom-2 top-8 rounded-full bg-[#D8A7C9]/16 blur-3xl md:inset-x-12 md:top-20" />
          <div className="absolute inset-0 rounded-[2rem] bg-[radial-gradient(circle_at_52%_46%,rgb(240_201_120_/_13%),transparent_28rem),radial-gradient(circle_at_68%_54%,rgb(216_167_201_/_12%),transparent_22rem)]" />
            ...
            return (
              <DetailCard key={item.title} className="p-5 md:p-6">
                <div className="flex gap-4">
                  <span className="flex size-12 shrink-0 items-center justify-center rounded-full border border-[rgba(217,180,106,0.34)] text-[#D8A7C9]">
...
export function PeonyHighlights() {
          ...
          {highlights.items.map((item) => (
            <DetailCard key={item.title} className="group">
              ...
              <div className="p-5 md:p-6">
                <span className="mb-4 block h-px w-12 bg-[#D8A7C9]/70" />
    ...
    <section className="border-y border-[rgba(217,180,106,0.16)] bg-[#090504] py-14 md:py-20">
      <div className="ysj-container">
        <div className="relative overflow-hidden rounded-[1.25rem] border border-[rgba(217,180,106,0.3)] bg-[linear-gradient(135deg,rgb(18_12_7_/_92%),rgb(7_6_4_/_98%))] p-3 shadow-[0_28px_90px_rgb(0_0_0_/_36%)] md:rounded-[1.6rem] md:p-5">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgb(216_167_201_/_10%),transparent_22rem),radial-gradient(circle_at_86%_76%,rgb(216_154_66_/_8%),transparent_20rem)]" />
                ...
                {craft.points.map((item, index) => {
                  ...
                  return (
                    <div key={item.title} className="rounded-[1rem] border border-[rgba(217,180,106,0.18)] bg-[#050302]/38 p-4 shadow-[inset_0_1px_0_rgb(248_230_191_/_5%)] md:p-5">
                      <div className="flex gap-4">
                        <span className="flex size-11 shrink-0 items-center justify-center rounded-full border border-[rgba(217,180,106,0.38)] bg-[#120907]/70 text-[#D8A7C9] md:size-12">
                          <Icon className="size-5" strokeWidth={1.45} />
                        </span>
                        <div>
    ...
    <section className="bg-[#070604] py-14 md:py-20">
      <div className="ysj-container">
        <div className="relative overflow-hidden rounded-[1.25rem] border border-[rgba(217,180,106,0.26)] bg-[linear-gradient(135deg,rgb(7_6_4_/_98%),rgb(22_16_10_/_92%))] p-3 shadow-[0_28px_90px_rgb(0_0_0_/_36%)] md:rounded-[1.6rem] md:p-5">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_64%,rgb(216_167_201_/_9%),transparent_24rem),linear-gradient(90deg,transparent,rgb(216_154_66_/_5%))]" />
                ...
                {taste.items.map((item, index) => {
                  ...
                  return (
                    <div key={item.title} className="rounded-[1rem] border border-[rgba(217,180,106,0.24)] bg-[#050302]/42 p-5 text-left shadow-[inset_0_1px_0_rgb(248_230_191_/_5%)]">
                      <div className="flex gap-4">
                        <span className="flex size-11 shrink-0 items-center justify-center rounded-full border border-[rgba(217,180,106,0.38)] bg-[#120907]/70 text-[#D8A7C9]">
                          <Icon className="size-5" strokeWidth={1.45} />
                        </span>
                        <div>
                          <h3 className="font-serif text-xl font-semibold text-[#F5E7C8]">{item.title}</h3>
      ...
      <div className="ysj-container">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
              ...
              {infoGift.scenes.map((item, index) => {
                ...
                return (
                  <div key={item.title} className="rounded-[1rem] border border-[rgba(217,180,106,0.2)] bg-[linear-gradient(135deg,rgb(18_12_7_/_78%),rgb(5_3_2_/_72%))] p-5">
                    <div className="flex gap-4">
                      <span className="flex size-11 shrink-0 items-center justify-center rounded-full border border-[rgba(217,180,106,0.34)] text-[#D8A7C9]">
                        <Icon className="size-5" strokeWidth={1.45} />
                      </span>
                      <div>
                        <h3 className="font-serif text-xl font-semibold text-[#F5E7C8]">{item.title}</h3>
          ...
          <div className="relative min-h-[300px] lg:min-h-[470px]">
            <div className="absolute inset-x-8 bottom-4 top-12 rounded-full bg-[#D8A7C9]/12 blur-3xl" />
...
export function PeonyCTA() {
  ...
  return (
    <section className="relative isolate overflow-hidden border-y border-[rgba(217,180,106,0.18)] bg-[#070604] py-14 md:py-22">
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_50%_0%,rgb(240_201_120_/_13%),transparent_30rem),radial-gradient(circle_at_72%_78%,rgb(216_167_201_/_10%),transparent_24rem),linear-gradient(180deg,#0F0B07_0%,#090504_100%)]" />
      <div className="absolute inset-x-0 bottom-0 -z-10 h-44 opacity-35 [background-image:radial-gradient(ellipse_at_center,transparent_35%,rgba(217,180,106,0.16)_36%,transparent_37%),linear-gradient(120deg,transparent_45%,rgba(216,167,201,0.12)_46%,transparent_48%)] [background-size:14rem_7rem,9rem_5rem]" />
