...
import { eggYolkLotusMooncakeProductData as pageData } from "@/data/egg-yolk-lotus-mooncake-detail";
...
export function EggYolkLotusMooncakeHero() {
  const { hero } = pageData;
...
export function EggYolkLotusMooncakeProblems() {
...
export function EggYolkLotusMooncakeHighlights() {
...
export function EggYolkLotusMooncakeCraft() {
      ...
      <div className="ysj-container">
        <div className="relative overflow-hidden rounded-[1.25rem] border border-[rgba(217,180,106,0.3)] bg-[linear-gradient(135deg,rgb(18_12_7_/_92%),rgb(7_6_4_/_98%))] p-4 shadow-[0_28px_90px_rgb(0_0_0_/_36%)] md:rounded-[1.6rem] md:p-7">
          ...
          <div className="relative">
            <SectionTitle title={craft.title} />
            <div className="mt-9 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
...
export function EggYolkLotusMooncakeTaste() {
...
export function EggYolkLotusMooncakeProcess() {
...
export function EggYolkLotusMooncakeInfoGift() {
...
export function EggYolkLotusMooncakeRecommendations() {
...
export function EggYolkLotusMooncakeCTA() {
