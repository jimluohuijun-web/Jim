        ...
        >
          ...
          <div className="relative grid gap-7 xl:grid-cols-[0.82fr_1.18fr] xl:items-center">
            ...
            <div className="flex flex-col gap-6 text-base leading-8 text-muted-foreground md:text-lg md:leading-9">
              <p>
                云酥坊不是把传统点心简单复刻一遍。我们更在意东方点心里那些细腻的层次：酥皮松开的声音、莲蓉与豆沙的温润、咸蛋黄的回香，以及手作留下来的温度。
              </p>
              <p>
                在这个基础上，云酥坊希望用更轻、更柔、更现代的方式呈现酥点。不追求过分甜腻，也不把东方元素做得喧闹，而是在口感、留白和细节里保留安静的东方气质。
              </p>
              <p>
                现在，品牌正在为温哥华市场做第一阶段准备。我们会先从小批量试吃、预约意向、季节风味测试和中秋礼盒预告开始，慢慢找到适合本地生活节奏的点心表达。
              </p>
            </div>
          </div>
        </motion.div>
