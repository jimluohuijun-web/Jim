export const pineappleProductData = {
  hero: {
    eyebrow: "云酥坊经典果香",
    name: "云酥坊・经典凤梨酥",
    ...
    tags: ["不是冬瓜馅", "不是冻品", "不是高糖", "100%凤梨果肉", "手工现烤", "低糖酸甜"],
    buttons: [
      { label: "立即抢购｜现做现发", href: "/reserve", variant: "primary" },
      { label: "查看送礼礼盒｜多规格可选", href: "/reserve", variant: "secondary" },
    ],
  },
  coreFeatures: {
    ...
    intro: "快速建立凤梨酥产品认知，让用户一眼看懂云酥坊的不同。",
    items: [
      {
        icon: "pineapple",
        title: "整块金钻凤梨馅",
        text: "酸甜果香，馅多实在，每口都能吃到果肉纤维，拒绝果泥调馅。",
        tag: "100%凤梨",
      },
      {
        icon: "layers",
        title: "超薄酥皮，入口即化",
        text: "36层薄酥折叠，外皮酥脆不厚重，掉渣不噎人。",
        tag: "36层酥皮",
      },
      {
        icon: "scale",
        title: "低糖果香比例",
        text: "糖度比普通凤梨酥低30%，酸甜平衡，老人小孩都能放心吃。",
        tag: "低糖30%",
      },
      {
        icon: "hand",
        title: "纯手工现做",
        text: "拒绝半成品冻品，手工包馅、现烤现发，出炉24小时内发货。",
        tag: "无冻品｜现做现发",
      },
    ],
  },
    ...
    layers: [
      {
        icon: "layers",
        title: "表层・金黄酥皮",
        text: "36层折叠，入口酥脆掉渣，无生硬感。",
      },
      {
        icon: "pineapple",
        title: "中层・整块凤梨馅",
        text: "果肉饱满多汁，酸甜不齁，纤维感清晰。",
      },
      {
        icon: "sparkles",
        title: "内芯・凤梨馅核心",
  ...
  productSpecs: {
    ...
    rows: [
      ["产品名称", "云酥坊经典凤梨酥"],
      ["净含量", "单枚30g，6枚装180g，12枚装360g"],
      ["保质期", "15天短保锁鲜"],
      ["产地", "福建漳州"],
      ["主要配料", "金钻凤梨果肉、高筋小麦粉、进口动物黄油、少量糖粉"],
      ["口感特色", "果香馅多、皮薄酥脆、酸甜平衡、清爽不腻"],
      ["新鲜优势", "现做现发、短保锁鲜、无防腐剂、出炉24小时内密封"],
      ["适用场景", "日常解馋、办公室下午茶、居家零食、节日伴手礼、走亲访友"],
      ["储存方式", "阴凉干燥处密封保存，冷藏后口感更佳"],
      ["食用建议", "开盒即食，无需加热；搭配茶类食用，解腻效果更佳"],
    ],
  ...
  bottomCTA: {
    ...
    guarantees: ["正品保障", "当天现做", "极速发货", "破损包赔"],
    riskFree: "拆封1枚不满意，剩余可退",
    afterSale: "7天无理由退换，未拆封即可",
  },
} as const;
